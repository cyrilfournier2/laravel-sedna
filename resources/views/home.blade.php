        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <form class="signup-form" action="{{ url('postContactForm') }}" method="POST" role="form">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <textarea  name="text" class="form-control" placeholder="Votre message">
                            </div>
                            <label for="comment">Message :</label>
                            <textarea type="textarea" class="form-control" name="text" placeholder="Entrez votre texte ici" ></textarea>
                        </div>

                        <button type="submit" class="btn btn-default" style="margin-top:15px">Envoyer</button>
                    </form>
                </div>
            </div>
        </div>
